Claro! Abaixo, está o README atualizado com as instruções para usar o `docker-compose` e as mudanças feitas na API:
...
Sinta-se livre para ajustar qualquer detalhe conforme a necessidade do seu projeto!
- **Upload de Arquivos**: Envie arquivos para o storage através de uma URL.
- **Download de Arquivos**: Baixe arquivos do storage usando um URL de download.
- **Listagem de Arquivos/Pastas**: Liste arquivos e/ou pastas com base em um prefixo de caminho, incluindo metadados como tamanho, última modificação e tipo.
...
Sinta-se livre para ajustar qualquer detalhe conforme a necessidade do seu projeto!# Simple Blob Storage com Flask
...
- Python
- Flask
- Docker e Docker ComposeClaro! Abaixo, está o README atualizado com as instruções para usar o `docker-compose` e as mudanças feitas na API:
